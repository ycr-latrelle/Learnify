...
import LoginFields from "../../components/features/LoginFields";

const HEADLINE = (
  <>
    Welcome back to the
    <br className="hidden md:block" /> study community.
  </>
);
const SUB =
  "Re-enter a study ecosystem designed for focus. Reconnect through shared knowledge, rhythmic study sessions, and sophisticated learning spaces.";
  ...
  return (
    ...
    >
      ...
      <div className="md:hidden flex flex-col">
        ...
        >
          ...
          <p className="text-[14px] text-neutral-500 leading-relaxed mb-7">
            Join our global assembly of thinkers and creators.
          </p>
          <LoginFields onSuccess={() => navigate("/profile")} />
        </div>
      ...
      <div className="hidden md:flex flex-1">
        <AuthBrandPanel headline={HEADLINE} sub={SUB} wavyPosition="mid" />

        <div className="flex-1 flex items-center justify-center px-6 py-14">
          <div
            className="w-full max-w-[440px] bg-white rounded-[28px] shadow-[var(--shadow-card)] px-11 py-11"
